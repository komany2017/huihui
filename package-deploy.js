...
for (const f of ['install.bat', 'install.ps1', 'manage.bat', 'manage.ps1', 'check.bat', 'check-env.ps1', 'fixbom.ps1', 'setup-nginx.ps1', 'setup-ssl.ps1', 'manage-nginx.bat', 'manage-nginx.ps1']) copyFile(path.join(serverDir, f), path.join(stage, f))
